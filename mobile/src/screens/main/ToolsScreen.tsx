...
import { COLORS, FONTS, SPACING, RADIUS, CEB_SLABS_SINGLE, GOLD_KARAT } from '../../utils/constants';
        ...
        <View style={{ flex: 1, marginRight: 8 }}>
          ...
          <View style={styles.pickerWrap}>
            <Picker selectedValue={from} onValueChange={setFrom} style={styles.picker} dropdownIconColor={COLORS.soft}>
              {currencies.map(c => <Picker.Item key={c} label={`${c} — ${NAMES[c]||c}`} value={c} color={COLORS.text} />)}
            </Picker>
          </View>
        </View>
        <View style={{ flex: 1 }}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={styles.pickerWrap}>
            <Picker selectedValue={karat} onValueChange={setKarat} style={styles.picker} dropdownIconColor={COLORS.soft}>
              {karats.map(k => <Picker.Item key={k} label={k} value={k} color={COLORS.text} />)}
            </Picker>
          </View>
        </View>
      </View>
    ...
    <View style={styles.toolCard}>
      ...
      <View style={styles.pickerWrap}>
        <Picker selectedValue={vType} onValueChange={setVType} style={styles.picker} dropdownIconColor={COLORS.soft}>
          {['Car', 'SUV/4WD', 'Motorcycle', 'Three-Wheeler', 'Van/Lorry'].map(v => <Picker.Item key={v} label={v} value={v} color={COLORS.text} />)}
        </Picker>
      </View>
      {vType !== 'Three-Wheeler' && (
        <>
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={styles.pickerWrap}>
            <Picker selectedValue={province} onValueChange={setProvince} style={styles.picker} dropdownIconColor={COLORS.soft}>
              {Object.keys(PROVINCES).map(p => <Picker.Item key={p} label={p} value={p} color={COLORS.text} />)}
            </Picker>
          </View>
        </View>
      </View>
